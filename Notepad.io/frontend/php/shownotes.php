...
<body>
    ...
    <form id="refreshform" action="../../frontend/php/shownotes.php" method="Post">
...
while($note=mysqli_fetch_array($notes)){
    if($note['N_Archived'] == 0){
?>
            <tr>
                <form action="../../backend/php/archive.php"  method="post">
                    <td>
                        <?php echo $note['N_Cod']?>
                    </td>
                    ...
                    <textarea name="actio" id="n_cod" style="display:none;"><?php echo 2?></textarea>
                    <td><button type="submit">Archive</button></td>
                </form>
                <form action="../../backend/php/archive.php" method="post">
                    <textarea name="ncod" id="n_cod" style="display:none;"><?php echo $note['N_Cod']?></textarea>
                    <textarea name="actio" id="n_cod" style="display:none;"><?php echo 0?></textarea>
                    <td><button type="submit">Complete</button></td>
                </form>
                <form action="../../frontend/php/read.php" method="post">
                    <textarea name="ncod" id="n_cod" style="display:none;"><?php echo $note['N_Cod']?></textarea>
